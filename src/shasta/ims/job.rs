...
pub struct Job {
    job_type: String,
    image_root_archive_name: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    kernel_file_name: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    initrd_file_name: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    kernel_parameters_file_name: Option<String>,
    artifact_id: String,
    public_key_id: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    ssh_containers: Option<Vec<SshContainer>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    enable_debug: Option<bool>,
    #[serde(skip_serializing_if = "Option::is_none")]
    buid_env_size: Option<u8>,
}
