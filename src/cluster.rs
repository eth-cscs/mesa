...
impl VCluster {
    pub async fn power_off(
        ...
        let hsm_group_node_list = hsm::group::utils::get_member_vec_from_hsm_group_name(
            shasta_token,
            shasta_base_url,
            shasta_root_cert,
            hsm_group_name,
    ...
    pub async fn get_boot_configuration(
        ...
        let hsm_group_node_boot_param_vec = crate::bss::bootparameters::http_client::get_raw(
            shasta_token,
            shasta_base_url,
            shasta_root_cert,
            &hsm_group_node_list,
